...
public class JwtTokenUtil implements Serializable {
    ...
    private Long getUserIdFromUserDetails(UserDetails userDetails) {
        if  (userDetails instanceof com.example.Project_BE.Project_BE.detail.AdminDetail) {
            return ((com.example.Project_BE.Project_BE.detail.AdminDetail) userDetails).getId();
        }
        return null;
    }
