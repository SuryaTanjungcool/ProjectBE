...
import com.example.Project_BE.Project_BE.detail.CustomAdminDetails;
...
//    private AuthService authService;
    ...
    private String jwtSecret = "family tree";
...
//                auth.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));
    ...
    ////                AdminDetails userDetails = new org.springframework.security.core.admin details.Admin(username, "", authorities);
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            if (jwtTokenUtil.validateToken(jwtToken)) {
                ...
                auth.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));
//                List<GrantedAuthority> authorities = getRolesFromToken(jwtToken);
//                UserDetails userDetails = new org.springframework.security.core.Admin details.User(username, "", authorities);
